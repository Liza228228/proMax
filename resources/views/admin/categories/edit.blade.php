                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.categories.update', $category) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="name_category" class="block mt-1 w-full" type="text" name="name_category" :value="old('name_category', $category->name_category)" required autofocus />
                        ...
                        <div class="mt-4">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="available" value="1" {{ old('available', $category->available) ? 'checked' : '' }} class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800">
